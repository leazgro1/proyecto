    ...
    if(!validaTelefono(tel)){
      ...
      $.ajax({
        ...
        success: function(data){
          if(!(data == "false")){
            limpiar();
            document.getElementById("idPop").innerHTML ='<a href="'+data+'" target="_self">Click Aqui para ver el video</a></p>';
            openModal();
          }
        }
      });
...
<div class="container my-container">
    <div class="row my-row">
        <div class="col-sm-12">
        <br>
            <p class="text-p"> Aqui puedes ver los webinars de las mejores herramientas de Monitoreo, Respaldo y Replicacion.</p>
        </div>
    </div>
</div>
